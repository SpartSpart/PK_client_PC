...
export { directive, DirectiveFn, isDirective } from 'lit-html/lib/directive.js';
export { removeNodes, reparentNodes } from 'lit-html/lib/dom.js';
export { noChange, nothing, Part } from 'lit-html/lib/part.js';
...
export { RenderOptions } from 'lit-html/lib/render-options.js';
...
export { TemplateProcessor } from 'lit-html/lib/template-processor.js';
